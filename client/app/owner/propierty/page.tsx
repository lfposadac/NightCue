...
const Propierty = () => {
  ...
  const handleDelete = (propiertyId: string) => {
    fetch(`http://localhost:3000/api/v1/propierty/${propiertyId}`, {
      ...
      .then((data) => {
        if (data.success) {
          setPropierties(propierties.filter((propierty) => propierty._id !== propiertyId));
        }
      })
      .catch((error) => {
  ...
  return (
    ...
    <Container className={styles.container}>
              ...
              <tr key={propierty._id}>
                ...
                <td>
                  <div className={styles.buttonContainer}>
                    <Button variant="warning" onClick={() => handleEdit(propierty)} className={styles.button}>
                      Editar
                    </Button>
                    <Button variant="danger" onClick={() => handleDelete(propierty._id)} className={styles.button}>
                      Eliminar
                    </Button>
                  </div>
                </td>
      ...
      <Modal isOpen={modal} toggle={toggleModal} className={styles.modalContainer}>
          ...
          <div className={styles.editContainer}>
            <FormGroup>
              ...
              <Input
                ...
                onChange={(e) => handlePropiertyChange("name", e.target.value)}
              />
            </FormGroup>
            <FormGroup>
              ...
              <Input
                ...
                onChange={(e) => handlePropiertyChange("capacity", e.target.value)}
              />
            </FormGroup>
            <FormGroup>
              ...
              <Input
                ...
                onChange={(e) => handlePropiertyChange("address", e.target.value)}
              />
            </FormGroup>
            <FormGroup>
              ...
              <Input
                ...
                onChange={(e) => handlePropiertyChange("contact", e.target.value)}
              />
            </FormGroup>
            <FormGroup>
              ...
              <Input
                ...
                onChange={(e) => handlePropiertyChange("schedule", e.target.value)}
              />
            </FormGroup>
          </div>
        </ModalBody>
        <ModalFooter>
          ...
          <Button color="secondary" onClick={toggleModal} className={styles.button}>
            Cancel
          </Button>
        </ModalFooter>
      </Modal>
